  ...
  return (
    <section className="w-full  py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        {/* HEADING */}
        <h2 className="text-center text-black text-2xl md:text-3xl font-bold font-['Khula'] mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-24 justify-items-center">
          ...
          {/* CARD 1 */}
          <div className="w-72 h-64 bg-[#E5F8F6] text-black flex flex-col items-center justify-start pt-10 gap-4">
          ...
          {/* CARD 2 */}
          <div className="w-72 h-64 bg-orange-50 text-black flex flex-col items-center justify-start pt-10 gap-4">
            ...
            <h3 className="text-lg font-bold text-black font-['Khula']">Email Address</h3>
            <p className="text-xs text-black font-['Nunito_Sans']">
              help@eduecho.in
            </p>
          </div>

          {/* CARD 3 */}
          <div className="w-72 h-64 bg-green-50  text-black flex flex-col items-center justify-start pt-10 gap-4 px-4">
            ...
            <h3 className="text-lg font-bold text-black font-['Khula']">Address</h3>
            <p className="text-xs text-center font-['Nunito_Sans']">
